...
void signin(){
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            Log.d("fb","fb = "+user.getDisplayName());
            Log.d("fb","fb = "+user.getPhoneNumber());
            Log.d("fb","fb = "+user.getEmail());
            prefernces.setfbname(user.getDisplayName());
            prefernces.setfbmail(user.getEmail());
            prefernces.setfbnum(user.getPhoneNumber());
            prefernces.setFbSession(1);
            super.onBackPressed();
